...
export async function GET() {
  try {
    ...
    const selects = [
      "id, trial_used_at, trial_ends_at, subscription_ended_at, subscription_cancelled_at, last_payment_at, last_payment_amount, last_payment_failed_at, last_invoice_url",
