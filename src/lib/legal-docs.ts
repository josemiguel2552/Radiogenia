...
export const LEGAL_DOCS: Record<string, Docs> = {
      ...
      sections: [
        {
          ...
          content: [
            ...
            "Radiogen.AI NO es un producto sanitario ni un dispositivo médico. No está destinado, ni debe utilizarse, con fines de diagnóstico, prevención, control, predicción, pronóstico, tratamiento o alivio de enfermedades. Es una herramienta administrativa de documentación y redacción de informes que asiste al radiólogo en la redacción; el resultado clínico depende exclusivamente del juicio del profesional.",
          ],
        },
        {
      ...
      sections: [
        {
          ...
          content: [
            ...
            "Radiogen.AI NO es un producto sanitario ni un dispositivo médico y no está destinado a fines de diagnóstico. Es una herramienta de apoyo a la redacción y documentación de informes. Cualquier sugerencia de clasificación o estadificación (TNM, BI-RADS, TI-RADS, LI-RADS u otros) es una ayuda a la redacción a partir de lo que el radiólogo dicta; no constituye un diagnóstico ni una decisión clínica, y el radiólogo debe verificarla y validarla.",
          ],
        },
        {
  ...
  en: {
      ...
      sections: [
        {
          ...
          content: [
            ...
            "Radiogen.AI is NOT a medical device. It is not intended for, and must not be used for, the diagnosis, prevention, monitoring, prediction, prognosis, treatment, or alleviation of disease. It is an administrative documentation and report-drafting tool that assists the radiologist in writing; the clinical outcome depends solely on the professional's judgment.",
          ],
        },
        {
    ...
    ai_disclaimer: {
      ...
      updated: "Last updated: May 2026",
      sections: [
        { title: "1. Nature of AI", content: ["Radiogen.AI is a radiology report structuring tool. The platform takes the radiologist's dictation and organizes it into findings and conclusion sections, structuring the information that the professional authorizes and writes. Radiogen.AI does NOT interpret medical images, does NOT make diagnoses, does NOT issue clinical or therapeutic recommendations, and does NOT generate findings not dictated by the user. The platform is exclusively an organizing and structuring tool for content provided by the radiologist.", "Radiogen.AI is NOT a medical device and is not intended for diagnostic purposes. It is a report drafting and documentation aid. Any classification or staging suggestion (TNM, BI-RADS, TI-RADS, LI-RADS, or others) is a writing aid based on what the radiologist dictates; it does not constitute a diagnosis or a clinical decision, and the radiologist must verify and validate it."] },
