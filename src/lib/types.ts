...
export const PROVIDERS: { value: AIProvider; label: string; models: string[] }[] = [
  ...
  { value: "openai", label: "GPT (OpenAI)", models: ["gpt-4o", "gpt-4o-mini", "gpt-5.6-luna"] },
  { value: "deepseek", label: "DeepSeek", models: ["deepseek-flash", "deepseek-v4-pro", "deepseek-v4-flash"] },
