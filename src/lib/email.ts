...
const welcomeI18n: Record<EmailLang, {
  ...
  es: {
    ...
    feat1: "20 informes/mes en el plan gratuito",
  ...
  en: {
    ...
    feat1: "20 reports/month on the free plan",
  ...
  pt: {
    ...
    feat1: "20 laudos/m&ecirc;s no plano gratuito",
