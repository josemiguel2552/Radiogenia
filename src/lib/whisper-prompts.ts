...
const PROMPT_ES = `Dictado de informe radiológico en español. Comandos de voz: punto nueva línea, punto, coma, punto y aparte, punto y seguido, dos puntos, nueva línea, nuevo párrafo, punto y coma.
...
Nódulo, masa, lesión focal, quiste, colección, engrosamiento, calcificación, realce, captación de contraste, restricción en difusión, hiperintenso en T2, hipointenso en T1, señal heterogénea, hipodenso, hiperdenso, mal definido.
Fase arterial, fase portal, fase venosa, fase tardía, contraste intravenoso, contraste oral, fenómeno de perfusión transitoria.
Milímetros, centímetros, diámetro máximo, diámetro transverso, diámetro anteroposterior, diámetro craneocaudal, eje mayor, eje menor, calibre.
Atelectasia, consolidación, derrame pleural, neumotórax, bronquiectasias, enfisema, cardiomegalia, tromboembolismo pulmonar.
Hidronefrosis, hidrouréter, nefrolitiasis, urolitiasis, cálculo renal, pielonefritis, grasa perirrenal.
...
const PROMPT_EN = `Radiology report dictation in English. Voice commands: period new line, period, comma, new line, new paragraph, colon, next line, semicolon.
...
Nodule, mass, focal lesion, cyst, collection, thickening, calcification, enhancement, contrast uptake, diffusion restriction, T2 hyperintense, T1 hypointense, heterogeneous signal, hypodense, hyperdense, ill-defined.
Arterial phase, portal venous phase, delayed phase, intravenous contrast, oral contrast, transient perfusion phenomena, transient hepatic attenuation difference.
Millimeters, centimeters, maximum diameter, transverse diameter, anteroposterior diameter, craniocaudal, long axis, short axis, caliber, calibre.
...
Hydronephrosis, hydroureter, nephrolithiasis, urolithiasis, renal calculus, pyelonephritis, perinephric fat stranding.
