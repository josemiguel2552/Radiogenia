...
export const SKINS: Skin[] = [
  ...
  /* Mid-tone light skins: a muted, low-saturation ground rather than white
     or a pastel, each paired with one deeper accent for contrast. */
  {
    id: "salvia",
    isDark: false,
    preview: { bg: "#c4d8c6", primary: "#b54e2b", card: "#d7e8d9", fg: "#1a2e22" },
    vars: {
      background: "130 22% 82%",
      foreground: "150 28% 14%",
      card: "128 26% 90%",
      "card-foreground": "150 28% 14%",
      popover: "128 26% 90%",
      "popover-foreground": "150 28% 14%",
      primary: "14 62% 44%",
      "primary-foreground": "0 0% 100%",
      secondary: "130 20% 76%",
      "secondary-foreground": "150 26% 17%",
      muted: "130 20% 76%",
      "muted-foreground": "140 14% 36%",
      accent: "130 20% 76%",
      "accent-foreground": "150 26% 17%",
      destructive: "0 72% 48%",
      "destructive-foreground": "0 0% 100%",
      border: "130 18% 71%",
      input: "130 18% 71%",
  ...
  },
  {
    id: "glicina",
    isDark: false,
    preview: { bg: "#d5cbe8", primary: "#8a3fa3", card: "#e6ddf5", fg: "#221a30" },
    vars: {
      background: "268 28% 85%",
      ...
      "primary-foreground": "0 0% 100%",
      secondary: "268 24% 79%",
      "secondary-foreground": "270 28% 19%",
      muted: "268 24% 79%",
      "muted-foreground": "268 16% 40%",
      accent: "268 24% 79%",
      "accent-foreground": "270 28% 19%",
      destructive: "0 72% 48%",
      "destructive-foreground": "0 0% 100%",
      border: "268 22% 74%",
      input: "268 22% 74%",
  ...
  },
  {
    id: "niebla",
    isDark: false,
    preview: { bg: "#ded1bd", primary: "#19798f", card: "#eee4d3", fg: "#1b2f38" },
    vars: {
      background: "38 24% 84%",
      foreground: "200 28% 15%",
      card: "40 30% 91%",
      "card-foreground": "200 28% 15%",
      popover: "40 30% 91%",
      "popover-foreground": "200 28% 15%",
      primary: "192 68% 31%",
      "primary-foreground": "0 0% 100%",
      secondary: "38 20% 78%",
      "secondary-foreground": "200 26% 17%",
      muted: "38 20% 78%",
      "muted-foreground": "38 12% 38%",
      accent: "38 20% 78%",
      "accent-foreground": "200 26% 17%",
      destructive: "0 72% 48%",
      "destructive-foreground": "0 0% 100%",
      border: "38 18% 73%",
      input: "38 18% 73%",
  ...
  },
  {
    id: "pizarra",
    isDark: false,
    preview: { bg: "#c7d2e0", primary: "#a73553", card: "#dde5ef", fg: "#1b2233" },
    vars: {
      background: "212 26% 84%",
  ...
  },
  {
    id: "porcelana",
    isDark: false,
    preview: { bg: "#cfe2e8", primary: "#a66a27", card: "#e3f0f4", fg: "#1a2c33" },
    vars: {
      background: "195 28% 85%",
      foreground: "200 32% 15%",
      card: "194 34% 92%",
      "card-foreground": "200 32% 15%",
      popover: "194 34% 92%",
      "popover-foreground": "200 32% 15%",
      primary: "30 62% 40%",
      "primary-foreground": "0 0% 100%",
      secondary: "195 24% 79%",
      "secondary-foreground": "200 28% 19%",
      muted: "195 24% 79%",
      "muted-foreground": "197 16% 38%",
      accent: "195 24% 79%",
      "accent-foreground": "200 28% 19%",
      destructive: "0 72% 48%",
      "destructive-foreground": "0 0% 100%",
      border: "195 22% 74%",
      input: "195 22% 74%",
  ...
  },
  {
    id: "oliva",
    isDark: false,
    preview: { bg: "#d6dec3", primary: "#864586", card: "#e8eed9", fg: "#262e14" },
    vars: {
      background: "78 24% 82%",
      foreground: "80 30% 14%",
      card: "76 28% 90%",
      "card-foreground": "80 30% 14%",
      popover: "76 28% 90%",
      "popover-foreground": "80 30% 14%",
      primary: "300 32% 40%",
      "primary-foreground": "0 0% 100%",
      secondary: "78 22% 76%",
      "secondary-foreground": "80 28% 17%",
      muted: "78 22% 76%",
      "muted-foreground": "78 14% 36%",
      accent: "78 22% 76%",
      "accent-foreground": "80 28% 17%",
      destructive: "0 72% 48%",
      "destructive-foreground": "0 0% 100%",
      border: "78 20% 71%",
      input: "78 20% 71%",
