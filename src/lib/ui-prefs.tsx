...
export const SKINS: Skin[] = [
  ...
  },
  {
    id: "medianoche",
    isDark: true,
    preview: { bg: "#0a1a33", primary: "#38bdf8", card: "#122850", fg: "#e0f0ff" },
    vars: {
  ...
  },
  {
    id: "acero",
    isDark: true,
    preview: { bg: "#151b23", primary: "#60a5fa", card: "#1e2530", fg: "#d1dae6" },
    vars: {
      background: "215 22% 11%",
      foreground: "214 30% 88%",
      card: "215 18% 15%",
      "card-foreground": "214 30% 88%",
      popover: "215 18% 15%",
      "popover-foreground": "214 30% 88%",
      primary: "217 91% 68%",
      "primary-foreground": "215 22% 11%",
      secondary: "215 15% 20%",
      "secondary-foreground": "214 20% 85%",
      muted: "215 15% 20%",
      "muted-foreground": "215 12% 50%",
      accent: "215 15% 20%",
      "accent-foreground": "214 20% 85%",
      destructive: "0 62% 45%",
      "destructive-foreground": "0 0% 100%",
      border: "215 12% 23%",
      input: "215 12% 23%",
  ...
  },
  {
    id: "oceano",
    isDark: true,
    preview: { bg: "#0c1e2e", primary: "#2dd4bf", card: "#122d40", fg: "#d0f0ea" },
    vars: {
      background: "205 50% 11%",
      ...
      primary: "174 72% 56%",
      "primary-foreground": "205 50% 11%",
      secondary: "203 28% 22%",
      "secondary-foreground": "170 30% 85%",
      muted: "203 28% 22%",
      "muted-foreground": "200 18% 50%",
      accent: "203 28% 22%",
