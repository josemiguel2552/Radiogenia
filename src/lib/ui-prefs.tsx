...
export const SKINS: Skin[] = [
     ...
     or a pastel, each paired with one deeper accent for contrast. */
  {
    id: "salvia",
    isDark: false,
    preview: { bg: "#dbe3da", primary: "#b25635", card: "#edf3ec", fg: "#1f2e27" },
    vars: {
      background: "125 12% 88%",
  ...
  },
  {
    id: "glicina",
    isDark: false,
    preview: { bg: "#e2ddeb", primary: "#7e4a93", card: "#f1eef8", fg: "#241f33" },
    vars: {
      background: "265 18% 90%",
      foreground: "270 25% 16%",
      card: "265 22% 95%",
      "card-foreground": "270 25% 16%",
      popover: "265 22% 95%",
      "popover-foreground": "270 25% 16%",
      primary: "288 33% 43%",
      "primary-foreground": "0 0% 100%",
      secondary: "265 16% 84%",
      "secondary-foreground": "270 22% 20%",
      muted: "265 16% 84%",
      "muted-foreground": "268 12% 44%",
      accent: "265 16% 84%",
      "accent-foreground": "270 22% 20%",
      destructive: "0 72% 48%",
      "destructive-foreground": "0 0% 100%",
      border: "265 15% 80%",
      input: "265 15% 80%",
  ...
  },
  {
    id: "niebla",
    isDark: false,
    preview: { bg: "#e6e2db", primary: "#21788c", card: "#f5f2ec", fg: "#1d2f38" },
    vars: {
      background: "40 12% 89%",
      ...
      "primary-foreground": "0 0% 100%",
      secondary: "40 12% 83%",
      "secondary-foreground": "200 22% 18%",
      muted: "40 12% 83%",
  ...
  },
  {
    id: "pizarra",
    isDark: false,
    preview: { bg: "#dbdfe5", primary: "#9b3a52", card: "#eef1f5", fg: "#1f2633" },
    vars: {
      background: "215 16% 88%",
      ...
      muted: "215 14% 82%",
      "muted-foreground": "217 10% 42%",
      accent: "215 14% 82%",
      "accent-foreground": "220 22% 20%",
      destructive: "0 72% 48%",
      "destructive-foreground": "0 0% 100%",
      border: "215 14% 78%",
      input: "215 14% 78%",
