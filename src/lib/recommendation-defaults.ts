...
export const DEFAULT_RECOMMENDATIONS: ManualRecommendation[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    category: "Abdomen and pelvis",
    modality: "all",
    title: { es: "AAA 3-3.9cm: eco cada 3 años", en: "AAA 3-3.9cm: US every 3 years", pt: "AAA 3-3.9cm: eco a cada 3 anos" },
    text: {
      es: "Aneurisma de aorta abdominal de 3-3.9 cm. Se recomienda ecografía de control cada 3 años (SVS 2018).",
      en: "Abdominal aortic aneurysm 3-3.9 cm. Surveillance ultrasound every 3 years recommended (SVS 2018).",
      pt: "Aneurisma de aorta abdominal de 3-3.9 cm. Ecografia de controle a cada 3 anos recomendada (SVS 2018).",
    },
  ...
  },
  {
    ...
    category: "Abdomen and pelvis",
    modality: "all",
    title: { es: "AAA 4-4.9cm: eco anual", en: "AAA 4-4.9cm: annual US", pt: "AAA 4-4.9cm: eco anual" },
    text: {
      es: "Aneurisma de aorta abdominal de 4-4.9 cm. Se recomienda ecografía o TC de control cada 12 meses (SVS 2018).",
      en: "Abdominal aortic aneurysm 4-4.9 cm. Surveillance ultrasound or CT every 12 months recommended (SVS 2018).",
      pt: "Aneurisma de aorta abdominal de 4-4.9 cm. Ecografia ou TC de controle a cada 12 meses recomendada (SVS 2018).",
    },
    tags: ["aneurisma", "aneurysm", "aorta", "abdominal", "AAA"],
    source: "SVS Practice Guidelines 2018",
    scope: "system",
  },
  {
    ...
    category: "Abdomen and pelvis",
    modality: "all",
    title: { es: "AAA 5-5.4cm: eco 6 meses", en: "AAA 5-5.4cm: US 6 months", pt: "AAA 5-5.4cm: eco 6 meses" },
    text: {
      es: "Aneurisma de aorta abdominal de 5-5.4 cm. Se recomienda ecografía o TC de control cada 6 meses. En mujeres, considerar valoración quirúrgica a partir de 5.0 cm (umbral de reparación 5.0 cm en mujeres frente a 5.5 cm en hombres) (SVS 2018).",
      en: "Abdominal aortic aneurysm 5-5.4 cm. Surveillance ultrasound or CT every 6 months recommended. In women, consider surgical evaluation from 5.0 cm (repair threshold 5.0 cm in women vs 5.5 cm in men) (SVS 2018).",
      pt: "Aneurisma de aorta abdominal de 5-5.4 cm. Ecografia ou TC de controle a cada 6 meses recomendada. Em mulheres, considerar avaliação cirúrgica a partir de 5.0 cm (limiar de reparo 5.0 cm em mulheres vs 5.5 cm em homens) (SVS 2018).",
    },
    tags: ["aneurisma", "aneurysm", "aorta", "abdominal", "AAA", "mujer", "women"],
    source: "SVS Practice Guidelines 2018",
    scope: "system",
  },
  {
  ...
  // ═══════════════════════════════════════════
  {
    ...
    text: {
      es: "Diverticulitis aguda complicada con absceso (Hinchey Ib/II). Absceso pequeño <4-5 cm: antibioterapia intravenosa sola. Absceso ≥4-5 cm: drenaje percutáneo guiado por imagen más antibioterapia. Consulta quirúrgica (WSES 2020).",
      en: "Complicated acute diverticulitis with abscess (Hinchey Ib/II). Small abscess <4-5 cm: IV antibiotics alone. Abscess ≥4-5 cm: image-guided percutaneous drainage plus antibiotics. Surgical consultation (WSES 2020).",
      pt: "Diverticulite aguda complicada com abscesso (Hinchey Ib/II). Abscesso pequeno <4-5 cm: antibioticoterapia intravenosa isolada. Abscesso ≥4-5 cm: drenagem percutânea guiada por imagem mais antibioticoterapia. Consulta cirúrgica (WSES 2020).",
    },
  ...
  // ═══════════════════════════════════════════
  // COMPLETITUD — escenarios adicionales de guía
  // ═══════════════════════════════════════════
  {
    id: "lirads_nc",
    category: "Abdomen and pelvis",
    modality: "MRI",
    title: { es: "LI-RADS NC: no categorizable", en: "LI-RADS NC: not categorizable", pt: "LI-RADS NC: não categorizável" },
    text: {
      es: "LI-RADS NC (no categorizable). El estudio no permite asignar categoría por degradación de imagen u omisión de fases/secuencias necesarias. Se recomienda repetir o realizar imagen alternativa, generalmente en ≤3 meses (mismo método si el problema técnico es subsanable; si no, otra técnica, p. ej. ecografía con contraste) (ACR LI-RADS v2018).",
      en: "LI-RADS NC (not categorizable). Category cannot be assigned due to image degradation or omission of required phases/sequences. Repeat or alternative imaging recommended, generally within ≤3 months (same modality if the technical issue is resolvable; otherwise a different technique, e.g. contrast-enhanced US) (ACR LI-RADS v2018).",
      pt: "LI-RADS NC (não categorizável). O estudo não permite atribuir categoria por degradação de imagem ou omissão de fases/sequências necessárias. Repetir ou realizar imagem alternativa, geralmente em ≤3 meses (mesmo método se o problema técnico for solucionável; caso contrário, outra técnica, ex. ecografia com contraste) (ACR LI-RADS v2018).",
    },
    tags: ["LI-RADS", "NC", "no categorizable", "not categorizable", "hígado", "liver", "CHC", "HCC"],
    source: "ACR LI-RADS v2018",
    scope: "system",
  },
  {
    ...
    category: "Abdomen and pelvis",
    modality: "Ultrasound",
    title: { es: "O-RADS US 3: riesgo bajo", en: "O-RADS US 3: low risk", pt: "O-RADS US 3: risco baixo" },
    text: {
      es: "O-RADS US 3 (riesgo bajo de malignidad, 1-<10%). Se recomienda ecografía de control en 6 meses si no se extirpa (y a 12 y 24 meses si permanece estable); para lesiones sólidas o quísticas con componente sólido, caracterización adicional por ecografista experto o RM (O-RADS RM) (ACR O-RADS US v2022).",
      en: "O-RADS US 3 (low risk of malignancy, 1-<10%). Follow-up US at 6 months if not excised (and at 12 and 24 months if stable); for solid lesions or cystic lesions with a solid component, further characterization by a US specialist or MRI (O-RADS MRI) (ACR O-RADS US v2022).",
      pt: "O-RADS US 3 (risco baixo de malignidade, 1-<10%). Ecografia de controle em 6 meses se não excisada (e em 12 e 24 meses se estável); para lesões sólidas ou císticas com componente sólido, caracterização adicional por ecografista experto ou RM (O-RADS RM) (ACR O-RADS US v2022).",
    },
    tags: ["O-RADS", "US", "ecografía", "ultrasound", "anexial", "adnexal", "ovario", "ovary", "riesgo bajo", "low risk"],
    source: "ACR O-RADS US v2022 (Strachowski LM et al., Radiology 2023)",
    scope: "system",
  },
  {
    ...
    category: "Abdomen and pelvis",
    modality: "Ultrasound",
    title: { es: "O-RADS US 4: riesgo intermedio", en: "O-RADS US 4: intermediate risk", pt: "O-RADS US 4: risco intermediário" },
    text: {
      es: "O-RADS US 4 (riesgo intermedio de malignidad, 10-<50%). Se recomienda RM para caracterización adicional y/o derivación; manejo por ginecólogo o ginecólogo-oncólogo (ACR O-RADS US v2022).",
      en: "O-RADS US 4 (intermediate risk of malignancy, 10-<50%). MRI for further characterization and/or referral recommended; management by a gynecologist or gynecologic oncologist (ACR O-RADS US v2022).",
      pt: "O-RADS US 4 (risco intermediário de malignidade, 10-<50%). RM para caracterização adicional e/ou encaminhamento recomendada; manejo por ginecologista ou ginecologista-oncologista (ACR O-RADS US v2022).",
    },
    tags: ["O-RADS", "US", "ecografía", "ultrasound", "anexial", "adnexal", "ovario", "ovary", "riesgo intermedio", "intermediate"],
    source: "ACR O-RADS US v2022 (Strachowski LM et al., Radiology 2023)",
    scope: "system",
  },
  {
    ...
    category: "Abdomen and pelvis",
    modality: "Ultrasound",
    title: { es: "O-RADS US 5: riesgo alto", en: "O-RADS US 5: high risk", pt: "O-RADS US 5: risco alto" },
    text: {
      es: "O-RADS US 5 (riesgo alto de malignidad, ≥50%). Se recomienda derivación a ginecólogo-oncólogo (ACR O-RADS US v2022).",
      en: "O-RADS US 5 (high risk of malignancy, ≥50%). Referral to a gynecologic oncologist recommended (ACR O-RADS US v2022).",
      pt: "O-RADS US 5 (risco alto de malignidade, ≥50%). Encaminhamento a ginecologista-oncologista recomendado (ACR O-RADS US v2022).",
    },
    tags: ["O-RADS", "US", "ecografía", "ultrasound", "anexial", "adnexal", "ovario", "ovary", "riesgo alto", "high risk", "oncología"],
    source: "ACR O-RADS US v2022 (Strachowski LM et al., Radiology 2023)",
    scope: "system",
  },
  {
    ...
    category: "Abdomen and pelvis",
    modality: "MRI",
    title: { es: "O-RADS RM 2: casi seguramente benigno", en: "O-RADS MRI 2: almost certainly benign", pt: "O-RADS RM 2: quase certamente benigno" },
    text: {
      es: "O-RADS RM 2 (casi seguramente benigno, VPP <0.5%): quiste simple, quiste hemorrágico clásico, endometrioma típico, teratoma quístico maduro, hidrosálpinx, etc. En general no requiere seguimiento; vigilancia o manejo ginecológico solo en subgrupos seleccionados (ACR O-RADS RM 2022).",
      en: "O-RADS MRI 2 (almost certainly benign, PPV <0.5%): simple cyst, classic hemorrhagic cyst, typical endometrioma, mature cystic teratoma, hydrosalpinx, etc. Generally no follow-up; surveillance or gynecologic management only in selected subgroups (ACR O-RADS MRI 2022).",
      pt: "O-RADS RM 2 (quase certamente benigno, VPP <0.5%): cisto simples, cisto hemorrágico clássico, endometrioma típico, teratoma cístico maduro, hidrossalpinge, etc. Em geral não requer seguimento; vigilância ou manejo ginecológico apenas em subgrupos selecionados (ACR O-RADS RM 2022).",
    },
    tags: ["O-RADS", "RM", "MRI", "anexial", "adnexal", "ovario", "ovary", "benigno", "benign"],
    source: "ACR O-RADS MRI 2022 (Sadowski EA et al., Radiology 2022)",
    scope: "system",
  },
  {
    id: "adrenal_benign_hu",
    category: "Abdomen and pelvis",
    modality: "CT",
    title: { es: "Adrenal benigno (≤10 UH / grasa)", en: "Benign adrenal (≤10 HU / fat)", pt: "Adrenal benigno (≤10 UH / gordura)" },
    text: {
      es: "Masa suprarrenal homogénea con atenuación sin contraste ≤10 UH (adenoma rico en lípidos), o con grasa macroscópica (mielolipoma), o con caída de señal en RM en fase/opuesta. Es benigna con alta especificidad y no requiere seguimiento adicional, hasta 4 cm (ACR Incidental Adrenal 2017).",
      en: "Homogeneous adrenal mass with unenhanced attenuation ≤10 HU (lipid-rich adenoma), or with macroscopic fat (myelolipoma), or with signal drop on in/opposed-phase MRI. Benign with high specificity; no further follow-up needed, up to 4 cm (ACR Incidental Adrenal 2017).",
      pt: "Massa adrenal homogênea com atenuação sem contraste ≤10 UH (adenoma rico em lipídios), ou com gordura macroscópica (mielolipoma), ou com queda de sinal na RM em fase/oposta. Benigna com alta especificidade; não requer seguimento adicional, até 4 cm (ACR Incidental Adrenal 2017).",
    },
    tags: ["adrenal", "suprarrenal", "adenoma", "10 UH", "10 HU", "mielolipoma", "myelolipoma", "grasa", "fat", "benigno", "benign"],
    source: "ACR Incidental Adrenal Findings 2017",
    scope: "system",
  },
  {
    id: "adrenal_indeterminate",
    category: "Abdomen and pelvis",
    modality: "CT",
    title: { es: "Adrenal indeterminado (>10 UH)", en: "Indeterminate adrenal (>10 HU)", pt: "Adrenal indeterminado (>10 UH)" },
    text: {
      es: "Masa suprarrenal indeterminada (>10 UH en fase sin contraste, pobre en lípidos). Se recomienda TC con lavado de contraste (lavado absoluto ≥60% o relativo ≥40% sugiere adenoma). Si persiste indeterminada, valorar PET, biopsia o resección. En paciente con neoplasia conocida o crecimiento, caracterización expedita (ACR Incidental Adrenal 2017).",
      en: "Indeterminate adrenal mass (>10 HU on unenhanced phase, lipid-poor). Adrenal washout CT recommended (absolute washout ≥60% or relative ≥40% suggests adenoma). If still indeterminate, consider PET, biopsy, or resection. In a patient with known malignancy or interval growth, expedited characterization (ACR Incidental Adrenal 2017).",
      pt: "Massa adrenal indeterminada (>10 UH na fase sem contraste, pobre em lipídios). TC com washout de contraste recomendada (washout absoluto ≥60% ou relativo ≥40% sugere adenoma). Se persistir indeterminada, considerar PET, biópsia ou ressecção. Em paciente com neoplasia conhecida ou crescimento, caracterização expedita (ACR Incidental Adrenal 2017).",
    },
    tags: ["adrenal", "suprarrenal", "indeterminado", "indeterminate", "lavado", "washout", "PET", "biopsia"],
    source: "ACR Incidental Adrenal Findings 2017",
    scope: "system",
  },
  {
    id: "pancreas_worrisome",
    category: "Abdomen and pelvis",
    modality: "all",
    title: { es: "Quiste pancreático: rasgos preocupantes", en: "Pancreatic cyst: worrisome features", pt: "Cisto pancreático: características preocupantes" },
    text: {
      es: "Quiste pancreático con rasgos preocupantes: tamaño >3 cm, pared engrosada/realzada, conducto pancreático principal de 5-9 mm, nódulo mural no realzante, cambio brusco de calibre ductal con atrofia distal, o adenopatías. Se recomienda ecoendoscopia (± PAAF) y valoración multidisciplinar (ACR/AGA 2015-2017).",
      en: "Pancreatic cyst with worrisome features: size >3 cm, thickened/enhancing wall, main pancreatic duct 5-9 mm, non-enhancing mural nodule, abrupt ductal caliber change with distal atrophy, or lymphadenopathy. Endoscopic ultrasound (± FNA) and multidisciplinary evaluation recommended (ACR/AGA 2015-2017).",
      pt: "Cisto pancreático com características preocupantes: tamanho >3 cm, parede espessada/realçada, ducto pancreático principal de 5-9 mm, nódulo mural não realçante, mudança abrupta de calibre ductal com atrofia distal, ou linfonodomegalia. Ecoendoscopia (± PAAF) e avaliação multidisciplinar recomendadas (ACR/AGA 2015-2017).",
    },
    tags: ["páncreas", "pancreas", "quiste", "cyst", "IPMN", "preocupante", "worrisome", "ecoendoscopia", "EUS", "nódulo mural"],
    source: "ACR Incidental Findings 2017 / AGA Guidelines 2015",
    scope: "system",
  },
  {
    id: "pancreas_highrisk",
    category: "Abdomen and pelvis",
    modality: "all",
    title: { es: "Quiste pancreático: estigmas de alto riesgo", en: "Pancreatic cyst: high-risk stigmata", pt: "Cisto pancreático: estigmas de alto risco" },
    text: {
      es: "Quiste pancreático con estigmas de alto riesgo: ictericia obstructiva con lesión quística en cabeza, nódulo mural realzante ≥5 mm, o conducto pancreático principal ≥10 mm. Se recomienda derivación quirúrgica (ACR/AGA 2015-2017; Fukuoka IAP 2017).",
      en: "Pancreatic cyst with high-risk stigmata: obstructive jaundice with a cystic head lesion, enhancing mural nodule ≥5 mm, or main pancreatic duct ≥10 mm. Surgical referral recommended (ACR/AGA 2015-2017; Fukuoka IAP 2017).",
      pt: "Cisto pancreático com estigmas de alto risco: icterícia obstrutiva com lesão cística na cabeça, nódulo mural realçante ≥5 mm, ou ducto pancreático principal ≥10 mm. Encaminhamento cirúrgico recomendado (ACR/AGA 2015-2017; Fukuoka IAP 2017).",
    },
    tags: ["páncreas", "pancreas", "quiste", "cyst", "IPMN", "alto riesgo", "high risk", "cirugía", "surgery", "ictericia"],
    source: "ACR Incidental Findings 2017 / AGA Guidelines 2015",
    scope: "system",
  },
  {
    id: "gb_polyp_riskfactor",
    category: "Abdomen and pelvis",
    modality: "Ultrasound",
    title: { es: "Pólipo vesicular 6-9mm con factor de riesgo", en: "Gallbladder polyp 6-9mm with risk factor", pt: "Pólipo vesicular 6-9mm com fator de risco" },
    text: {
      es: "Pólipo vesicular de 6-9 mm con ≥1 factor de riesgo de malignidad (edad >50 años, colangitis esclerosante primaria, pólipo sésil o engrosamiento focal de pared >4 mm, etnia india). Se recomienda colecistectomía si el paciente es apto y la acepta; en su defecto, seguimiento ecográfico estrecho (Joint ESGAR/EAES/EFISDS/ESGE 2017).",
      en: "Gallbladder polyp 6-9 mm with ≥1 malignancy risk factor (age >50, primary sclerosing cholangitis, sessile polyp or focal wall thickening >4 mm, Indian ethnicity). Cholecystectomy recommended if the patient is fit and accepts; otherwise close US surveillance (Joint ESGAR/EAES/EFISDS/ESGE 2017).",
      pt: "Pólipo vesicular de 6-9 mm com ≥1 fator de risco de malignidade (idade >50 anos, colangite esclerosante primária, pólipo séssil ou espessamento focal de parede >4 mm, etnia indiana). Colecistectomia recomendada se o paciente for apto e aceitar; caso contrário, seguimento ecográfico estreito (Joint ESGAR/EAES/EFISDS/ESGE 2017).",
    },
    tags: ["pólipo", "polyp", "vesícula", "gallbladder", "factor de riesgo", "risk factor", "colecistectomía", "cholecystectomy"],
    source: "Joint ESGAR/EAES/EFISDS/ESGE Guidelines (Wiles R et al., Eur Radiol 2017)",
    scope: "system",
  },
  {
    ...
    category: "Thorax",
    modality: "CT",
    title: { es: "BTS: nódulo subsólido", en: "BTS: subsolid nodule", pt: "BTS: nódulo subsólido" },
    text: {
      es: "Nódulo subsólido (vidrio deslustrado puro o parcialmente sólido). Se recomienda TC de tórax de alta resolución a los 3 meses para confirmar persistencia; si se resuelve, es transitorio y se da el alta. Si persiste y ≥5 mm, aplicar el modelo de Brock; vigilancia con TC a 1, 2 y 4 años (mínimo 4 años). Intervenir (PET-TC, biopsia o resección) si hay crecimiento, aumento de densidad o aparición/crecimiento de un componente sólido (BTS 2015).",
      en: "Subsolid nodule (pure ground-glass or part-solid). High-resolution chest CT at 3 months to confirm persistence; if it resolves, it is transient and the patient is discharged. If persistent and ≥5 mm, apply the Brock model; surveillance CT at 1, 2, and 4 years (minimum 4 years). Intervene (PET-CT, biopsy, or resection) with growth, increasing attenuation, or development/growth of a solid component (BTS 2015).",
      pt: "Nódulo subsólido (vidro fosco puro ou parcialmente sólido). TC de tórax de alta resolução aos 3 meses para confirmar persistência; se resolver, é transitório e o paciente recebe alta. Se persistente e ≥5 mm, aplicar o modelo de Brock; vigilância com TC em 1, 2 e 4 anos (mínimo 4 anos). Intervir (PET-TC, biópsia ou ressecção) com crescimento, aumento de densidade ou surgimento/crescimento de componente sólido (BTS 2015).",
    },
    tags: ["BTS", "subsólido", "subsolid", "vidrio deslustrado", "ground-glass", "parcialmente sólido", "part-solid", "Brock", "nódulo", "nodule"],
    source: "BTS 2015 (Callister et al., Thorax 2015)",
    scope: "system",
  },
  {
    id: "bts_solid_riskmodel",
    category: "Thorax",
    modality: "CT",
    title: { es: "BTS: sólido ≥8mm (Brock/Herder)", en: "BTS: solid ≥8mm (Brock/Herder)", pt: "BTS: sólido ≥8mm (Brock/Herder)" },
    text: {
      es: "Nódulo sólido ≥8 mm o ≥300 mm³ indeterminado. Calcular riesgo de malignidad con el modelo de Brock: <10% → vigilancia con TC; ≥10% → PET-TC. Tras la PET-TC, reestimar con el modelo de Herder: <10% → vigilancia; 10-70% → biopsia guiada por imagen o vigilancia según decisión compartida; >70% → resección (VATS preferida) o tratamiento no quirúrgico (BTS 2015).",
      en: "Indeterminate solid nodule ≥8 mm or ≥300 mm³. Calculate malignancy risk with the Brock model: <10% → CT surveillance; ≥10% → PET-CT. After PET-CT, re-estimate with the Herder model: <10% → surveillance; 10-70% → image-guided biopsy or surveillance per shared decision; >70% → resection (VATS preferred) or non-surgical treatment (BTS 2015).",
      pt: "Nódulo sólido ≥8 mm ou ≥300 mm³ indeterminado. Calcular risco de malignidade com o modelo de Brock: <10% → vigilância com TC; ≥10% → PET-TC. Após a PET-TC, reestimar com o modelo de Herder: <10% → vigilância; 10-70% → biópsia guiada por imagem ou vigilância conforme decisão compartilhada; >70% → ressecção (VATS preferida) ou tratamento não cirúrgico (BTS 2015).",
    },
    tags: ["BTS", "sólido", "solid", "Brock", "Herder", "PET", "nódulo", "nodule", "riesgo", "risk"],
    source: "BTS 2015 (Callister et al., Thorax 2015)",
    scope: "system",
  },
  {
    ...
    category: "Head and neck",
    modality: "all",
    title: { es: "Estenosis carotídea <50%", en: "Carotid stenosis <50%", pt: "Estenose carotídea <50%" },
    text: {
      es: "Estenosis carotídea <50%. No se beneficia de revascularización (endarterectomía o stent); se recomienda tratamiento médico óptimo (antiagregación, estatina, control de factores de riesgo). La casi-oclusión ('trickle-flow') es una entidad distinta de menor riesgo, con manejo médico y revascularización solo ante síntomas recurrentes tras valoración multidisciplinar (AHA/ASA; NASCET).",
      en: "Carotid stenosis <50%. No benefit from revascularization (endarterectomy or stent); optimal medical therapy recommended (antiplatelet, statin, risk-factor control). Near-occlusion ('trickle-flow') is a distinct lower-risk entity, managed medically with revascularization only for recurrent symptoms after multidisciplinary review (AHA/ASA; NASCET).",
      pt: "Estenose carotídea <50%. Não se beneficia de revascularização (endarterectomia ou stent); terapia médica ótima recomendada (antiagregação, estatina, controle de fatores de risco). A quase-oclusão ('trickle-flow') é entidade distinta de menor risco, manejada clinicamente com revascularização apenas em sintomas recorrentes após avaliação multidisciplinar (AHA/ASA; NASCET).",
    },
    tags: ["carótida", "carotid", "estenosis", "stenosis", "<50%", "médico", "medical", "casi-oclusión", "near-occlusion"],
    source: "AHA/ASA Guidelines 2021; NASCET (NEJM 1991)",
    scope: "system",
  },
  {
    ...
    category: "Head and neck",
    modality: "all",
    title: { es: "Aneurisma cerebral gigante ≥25mm", en: "Giant cerebral aneurysm ≥25mm", pt: "Aneurisma cerebral gigante ≥25mm" },
    text: {
      es: "Aneurisma intracraneal gigante (≥25 mm). Riesgo de rotura muy alto (ISUIA: ~6-10%/año). Se recomienda tratamiento (clipaje o endovascular) salvo contraindicación, tras valoración neuroquirúrgica/neurointervencionista (AHA/ASA 2015; ISUIA).",
      en: "Giant intracranial aneurysm (≥25 mm). Very high rupture risk (ISUIA: ~6-10%/year). Treatment (clipping or endovascular) recommended unless contraindicated, after neurosurgical/neurointerventional evaluation (AHA/ASA 2015; ISUIA).",
      pt: "Aneurisma intracraniano gigante (≥25 mm). Risco de ruptura muito alto (ISUIA: ~6-10%/ano). Tratamento (clipagem ou endovascular) recomendado salvo contraindicação, após avaliação neurocirúrgica/neurointervencionista (AHA/ASA 2015; ISUIA).",
    },
    tags: ["aneurisma", "aneurysm", "gigante", "giant", "25mm", "cerebral", "intracraneal", "rotura", "rupture"],
    source: "AHA/ASA Guidelines 2015; ISUIA (Lancet 2003)",
    scope: "system",
  },
  {
    id: "aneurysm_symptomatic",
    category: "Head and neck",
    modality: "all",
    title: { es: "Aneurisma sintomático/compresivo", en: "Symptomatic/compressive aneurysm", pt: "Aneurisma sintomático/compressivo" },
    text: {
      es: "Aneurisma intracraneal sintomático (parálisis de par craneal, efecto de masa u otros síntomas compresivos), independientemente del tamaño. Constituye indicación de tratamiento; se recomienda valoración neuroquirúrgica/neurointervencionista urgente (AHA/ASA 2015).",
      en: "Symptomatic intracranial aneurysm (cranial nerve palsy, mass effect, or other compressive symptoms), regardless of size. This is a treatment indication; urgent neurosurgical/neurointerventional evaluation recommended (AHA/ASA 2015).",
      pt: "Aneurisma intracraniano sintomático (paralisia de nervo craniano, efeito de massa ou outros sintomas compressivos), independentemente do tamanho. Constitui indicação de tratamento; avaliação neurocirúrgica/neurointervencionista urgente recomendada (AHA/ASA 2015).",
    },
    tags: ["aneurisma", "aneurysm", "sintomático", "symptomatic", "compresivo", "compressive", "par craneal", "cranial nerve"],
    source: "AHA/ASA Guidelines 2015 (Thompson et al., Stroke 2015)",
    scope: "system",
  },
  {
    ...
    category: "Abdomen and pelvis",
    modality: "all",
    title: { es: "AAA de crecimiento rápido", en: "Rapidly growing AAA", pt: "AAA de crescimento rápido" },
    text: {
      es: "Aneurisma de aorta abdominal con crecimiento rápido (>0.5 cm en 6 meses o >1.0 cm en un año), independientemente del diámetro. Constituye indicación de reparación; se recomienda valoración quirúrgica (SVS 2018).",
      en: "Abdominal aortic aneurysm with rapid growth (>0.5 cm in 6 months or >1.0 cm in a year), regardless of diameter. This is a repair indication; surgical evaluation recommended (SVS 2018).",
      pt: "Aneurisma de aorta abdominal com crescimento rápido (>0.5 cm em 6 meses ou >1.0 cm em um ano), independentemente do diâmetro. Constitui indicação de reparo; avaliação cirúrgica recomendada (SVS 2018).",
    },
    tags: ["aneurisma", "aneurysm", "aorta", "AAA", "crecimiento", "growth", "rápido", "rapid", "cirugía", "surgery"],
    source: "SVS Practice Guidelines 2018",
    scope: "system",
  },
  {
    ...
    category: "Abdomen and pelvis",
    modality: "CT",
    title: { es: "Diverticulitis no complicada", en: "Uncomplicated diverticulitis", pt: "Diverticulite não complicada" },
    text: {
      es: "Diverticulitis aguda no complicada (WSES estadio 0 / Hinchey modificado 1a: inflamación pericólica sin absceso ni perforación). Se recomienda manejo ambulatorio; en pacientes inmunocompetentes seleccionados, observación sin antibióticos (uso selectivo, no rutinario) (WSES 2020).",
      en: "Acute uncomplicated diverticulitis (WSES stage 0 / modified Hinchey 1a: pericolic inflammation without abscess or perforation). Outpatient management recommended; in selected immunocompetent patients, observation without antibiotics (selective, not routine, use) (WSES 2020).",
      pt: "Diverticulite aguda não complicada (WSES estágio 0 / Hinchey modificado 1a: inflamação pericólica sem abscesso ou perfuração). Manejo ambulatorial recomendado; em pacientes imunocompetentes selecionados, observação sem antibióticos (uso seletivo, não rotineiro) (WSES 2020).",
    },
    tags: ["diverticulitis", "diverticulite", "no complicada", "uncomplicated", "Hinchey", "ambulatorio", "outpatient", "antibióticos"],
    source: "WSES Guidelines 2020; Modified Hinchey (Wasvary et al., Am Surg 1999)",
    scope: "system",
  },
  {
    id: "thoracic_aorta_experienced",
    category: "Thorax",
    modality: "all",
    title: { es: "Aorta ascendente 5-5.4cm", en: "Ascending aorta 5-5.4cm", pt: "Aorta ascendente 5-5.4cm" },
    text: {
      es: "Aneurisma de aorta ascendente de 5.0-5.4 cm. En centros con experiencia y equipo aórtico multidisciplinar, la cirugía es razonable (umbral ≥5.0 cm), frente al umbral general de ≥5.5 cm. Considerar además indexación por superficie corporal/altura y crecimiento ≥0.5 cm/año (≥0.3 cm/año en enfermedad hereditaria o válvula bicúspide) (ACC/AHA 2022).",
      en: "Ascending aortic aneurysm 5.0-5.4 cm. At experienced centers with a multidisciplinary aortic team, surgery is reasonable (threshold ≥5.0 cm), versus the general ≥5.5 cm threshold. Also consider body-surface-area/height indexing and growth ≥0.5 cm/year (≥0.3 cm/year in heritable disease or bicuspid valve) (ACC/AHA 2022).",
      pt: "Aneurisma de aorta ascendente de 5.0-5.4 cm. Em centros com experiência e equipe aórtica multidisciplinar, a cirurgia é razoável (limiar ≥5.0 cm), frente ao limiar geral de ≥5.5 cm. Considerar também indexação por superfície corporal/altura e crescimento ≥0.5 cm/ano (≥0.3 cm/ano em doença hereditária ou válvula bicúspide) (ACC/AHA 2022).",
    },
    tags: ["aorta", "ascendente", "ascending", "5cm", "torácica", "thoracic", "aneurisma", "aneurysm", "bicúspide", "bicuspid"],
    source: "ACC/AHA Aortic Disease Guidelines 2022 (Isselbacher et al.)",
    scope: "system",
  },
];
