...
const dict: Record<PublicLang, Record<string, string>> = {
  es: {
    ...
    "feat.classify.title": "Clasificación y estadificación",
    "feat.classify.desc": "Clasifica hallazgos con sistemas estándar (TNM, BI-RADS, TI-RADS, LI-RADS) automáticamente. Revisa antes de aplicar.",
  ...
  en: {
    ...
    "feat.classify.title": "Classification & Staging",
    "feat.classify.desc": "Classify findings using standard systems (TNM, BI-RADS, TI-RADS, LI-RADS) automatically. Review before applying.",
  ...
  pt: {
    ...
    "feat.classify.title": "Classificação e estadiamento",
    "feat.classify.desc": "Classifique achados com sistemas padrão (TNM, BI-RADS, TI-RADS, LI-RADS) automaticamente. Revise antes de aplicar.",
