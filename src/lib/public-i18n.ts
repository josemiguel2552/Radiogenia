...
const dict: Record<PublicLang, Record<string, string>> = {
  es: {
    ...
    "waitlist.password_placeholder": "Mínimo 6 caracteres",
    "waitlist.password_min": "La contraseña debe tener al menos 6 caracteres.",
  ...
  en: {
    ...
    "waitlist.password_placeholder": "At least 6 characters",
    "waitlist.password_min": "Password must be at least 6 characters.",
  ...
  pt: {
    ...
    "waitlist.password_placeholder": "Mínimo 6 caracteres",
    "waitlist.password_min": "A senha deve ter pelo menos 6 caracteres.",
