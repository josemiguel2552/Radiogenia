...
export const DEFAULT_TEMPLATES: Template[] = [
  ...
  t(191, "Whole Aorta CT Angiogram", "CT", "Thorax", [
    sec("Aortic root and ascending aorta"),
    fld("Aortic root diameter"),
    fld("Ascending aorta diameter and morphology"),
    sec("Aortic arch"),
    fld("Aortic arch diameter and morphology"),
    fld("Supra-aortic trunks"),
    sec("Descending thoracic aorta"),
    fld("Descending thoracic aorta diameter and morphology"),
    fld("Intercostal arteries"),
    sec("Abdominal aorta"),
    fld("Suprarenal aorta"),
    fld("Infrarenal aorta diameter and morphology"),
    sec("Visceral branches"),
    fld("Celiac trunk"),
    fld("Superior mesenteric artery"),
    fld("Renal arteries"),
    fld("Inferior mesenteric artery"),
    sec("Iliac arteries"),
    fld("Common iliac arteries"),
    fld("Internal iliac arteries"),
    fld("External iliac arteries"),
    sec("Aortic wall"),
    fld("Wall thickening or calcification"),
    fld("Intramural hematoma or dissection flap"),
    fld("Ulcerated plaques"),
    sec("Periaortic findings"),
    fld("Periaortic soft tissues and lymph nodes"),
    sec("Additional findings"),
    fld("Lung parenchyma"),
    fld("Pleura and pericardium"),
    fld("Intraabdominal organs"),
    fld("Bone structures"),
    fld("Other findings"),
  ].join("\n")),
